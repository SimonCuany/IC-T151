            ...
            <div class="nav-collapse collapse">
              <ul class="nav nav-pills ddmenu">
                  ...
                  <?php else :?>
                      ...
                      <h6>Bienvenue : <b><?php echo $_SESSION['userEmailAddress']?></b></h6>
                  <?php endif; ?>
              </ul>
            </div>
          </div>
      ...
      <div class="divPanel">
        <div class="row-fluid">
          ...
          <div class="span3" id="footerArea2">
            ...
            <p>
                <a href="https://www.rts.ch/archives/radio/sprint/10895983-au-micro-le-dr-paul-martin-ancien-champion-olympique-dathletisme-02-03-1940.html" title="">Paul champion suisse !</a><br />
