...
CREATE DATABASE IF NOT EXISTS `snowsLoginLogin` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci */;
USE `snowsLogin`;

-- Dumping structure for table snowsLogin.users
...
-- Dumping data for table snowsLogin.users: ~0 rows (approximately)
